...
public class Personaje {
     ...
     * @param maxItemsPorPersonaje Numero maximo de items que puede llevar el personaje
     * @param maxPesoPorPersonaje  Numero maximo de peso que puede cargar el personaje
     */
     ...
     *
     * @param indice permite devolver la posicion del item
     * @return Item items[]
     */
     ...
     *
     * @param danyo Daño que recibe el personaje
     */
     ...
     *
     * @param item Permite añadir el item señalado
